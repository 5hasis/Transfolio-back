...
include::{snippets}/board/regist/request-body.adoc[]
include::{snippets}/board/regist/response-body.adoc[]

=== 게시글 조회
include::{snippets}/board/{boardPid}/http-request.adoc[]
include::{snippets}/board/{boardPid}/http-response.adoc[]
include::{snippets}/board/{boardPid}/request-fields.adoc[]
...
include::{snippets}/board/bookmark/response-body.adoc[]
...
include:{snippets}/profile/portfolio/response-body.adoc[]

=== 경력
include::{snippets}/profile/career/http-request.adoc[]
include::{snippets}/profile/career/http-response.adoc[]
include::{snippets}/profile/career/response-body.adoc[]
...
include::{snippets}/todaysTranslator/response-body.adoc[]